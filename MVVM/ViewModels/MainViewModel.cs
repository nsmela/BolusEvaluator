...
public class DicomHeadersMessage : ValueChangedMessage<string> {
    public DicomHeadersMessage(string value) : base(value) { }
}
...
public partial class MainViewModel {
    ...
    [ObservableProperty] private string? _fileInfo, _detailsInfo;
    ...
    public MainViewModel() {
        WeakReferenceMessenger.Default.Register<DicomHeadersMessage>(this, (r, m) => {
